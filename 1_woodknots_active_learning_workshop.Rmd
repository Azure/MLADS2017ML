...
knitr::opts_chunk$set(echo = TRUE, cache=TRUE, message=FALSE, fig.height=7.5)
...
(initial_model_results$selected_labelled <- initial_model_results$selected %>% pseudolabel_function)

new_sample <- initial_model_results$selected_labelled %>% get_new_pseudolabelled_sample
