...
iteration_results <- lapply(1:NUM_ITERATIONS, function(i){
  ...
  results$selected <- select_cases(results$model, 
                                   unlabelled_knot_data_df[(unlabelled_knot_data_df$path %in% setdiff(unlabelled_knot_data_df$path, ALREADY_EVALUATED)),])
